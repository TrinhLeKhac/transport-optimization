from scripts.api.router import priority_route_api, api_output, api_ngung_giao_nhan, api_ngung_giao_nhan_rev, api_ngung_giao_nhan_level_3, api_ngung_giao_nhan_level_3_rev, order, zns, optimal_score, result, result_final, result_super
...
app.include_router(priority_route_api.router, tags=[""], prefix="/superai/priority_route/district", dependencies=[Depends(validate_token)])
...
app.include_router(api_ngung_giao_nhan_rev.router, tags=[""], prefix="/superai/get_status", dependencies=[Depends(validate_token)])
app.include_router(api_ngung_giao_nhan_level_3.router, tags=[""], prefix="/superai/v2/status", dependencies=[Depends(validate_token)])
app.include_router(api_ngung_giao_nhan_level_3_rev.router, tags=[""], prefix="/superai/v2/get_status", dependencies=[Depends(validate_token)])
