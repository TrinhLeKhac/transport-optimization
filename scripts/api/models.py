...
class MessageZNS(Base):
    ...
    feedbacks: Mapped[Union[List[str], None]] = mapped_column(ARRAY(String))
    note: Mapped[Union[str, None]] = mapped_column(String)
...
class Order(Base):
    ...
    order_status: Mapped[str] = mapped_column(String(1))
    carrier_id: Mapped[int] = mapped_column(Integer)
    carrier_status: Mapped[str] = mapped_column(String)
    ...
    picked_at: Mapped[str] = mapped_column(String)
    last_delivering_at: Mapped[Union[str, None]] = mapped_column(String)
...
class API(Base):
    ...
    time_display: Mapped[str] = mapped_column(String)
