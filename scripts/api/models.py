...
class MessageZNS(Base):
    ...
    feedbacks: Mapped[Union[List[str], None]] = mapped_column(ARRAY(String(100)))
    note: Mapped[Union[str, None]] = mapped_column(String(100))
...
class Order(Base):
    ...
    carrier_id: Mapped[int] = mapped_column(Integer)
    carrier_status: Mapped[str] = mapped_column(String(100))
