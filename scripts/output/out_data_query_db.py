...
def out_data_order_type(show_logs=True):
    ...
    input_df.loc[
        (((input_df['sender_province_id'] == '79') & (input_df['receiver_outer_region_id'] == 2)) \
        | ((input_df['sender_province_id'] == '01') & (input_df['receiver_outer_region_id'] == 0)) \
        | ((input_df['receiver_province_id'] == '79') & (input_df['sender_outer_region_id'] == 2)) \
        | ((input_df['receiver_province_id'] == '01') & (input_df['sender_outer_region_id'] == 0)))
        & (input_df['sys_order_type_id'] == -1),
        'sys_order_type_id'
    ] = 3
    input_df.loc[
    ...
    order_type_df = input_df[[
        ...
        'new_type', 'route_type']]
    order_type_df.columns = ['id', 'carrier_id', 'sender_province_code', 'sender_district_code', 'receiver_province_code', 'receiver_district_code', 'new_type', 'route_type']
    if show_logs:
        print('6. Saving data...')
