...
def xu_ly_phan_vung_nha_van_chuyen():
    # 1. Đọc thông tin raw
    try:
        phan_vung_nvc = pd.read_excel(ROOT_PATH + '/user_input/phan_vung_ghep_supership.xlsx', dtype=str)
        ...
        phan_vung_nvc = pd.read_excel(ROOT_PATH + '/input/phan_vung_ghep_supership.xlsx', dtype=str)
    ...
    phan_vung_nvc_final = phan_vung_nvc_final[
        ['carrier', 'receiver_province_code', 'receiver_district_code', 'outer_region', 'inner_region']]
